...
if("FALSE" STREQUAL "TRUE")
  set(motors_SOURCE_PREFIX /home/pi/robotfish/src/motors)
  set(motors_DEVEL_PREFIX /home/pi/robotfish/devel)
  set(motors_INSTALL_PREFIX "")
  set(motors_PREFIX ${motors_DEVEL_PREFIX})
else()
  set(motors_SOURCE_PREFIX "")
  set(motors_DEVEL_PREFIX "")
  set(motors_INSTALL_PREFIX /home/pi/robotfish/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'motors' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/pi/robotfish/install/${idir}'.  ${_report}")
    endif()
